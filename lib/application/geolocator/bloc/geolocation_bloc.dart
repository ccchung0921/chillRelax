...
class GeolocationBloc extends Bloc<GeolocationEvent, GeolocationState> {
  ...
  Stream<GeolocationState> mapEventToState(
    ...
    yield* event.map(getCurrentPosition: (e) async* {
      ...
      yield state.copyWith(selectedPlace: updatedPlace, isPlaceLoading: false);
    }, getDistance: (e) async* {
      ...
      yield state.copyWith(isPlaceLoading: true);
      final fetchedPlace =
          await SuggestionAPI(e.sessionToken).fetchSuggestionDetail(e.placeid);
      yield state.copyWith(selectedPlace: fetchedPlace, isPlaceLoading: false);
    });
  }
}
